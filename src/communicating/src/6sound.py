...
CHANNELS = 1
RATE = 44100
CHUNK = 1024 * 8# 1024 bytes of data read from the buffer
#RECORD_SECONDS = 0.1
...
def plot_data(in_data):
    ...
    #Fast Fourier Transform, 10*log10(abs) is to scale it to dB and make sure it's not imaginary
