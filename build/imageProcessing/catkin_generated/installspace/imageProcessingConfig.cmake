...
if("FALSE" STREQUAL "TRUE")
  set(imageProcessing_SOURCE_PREFIX /home/robotis/catkin_krsbi/src/imageProcessing)
  set(imageProcessing_DEVEL_PREFIX /home/robotis/catkin_krsbi/devel)
  ...
  set(imageProcessing_INSTALL_PREFIX /home/robotis/catkin_krsbi/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imageProcessing' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'imageProcessing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT imageProcessing_NUM_DUMMY_TARGETS)
      set(imageProcessing_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::imageProcessing::wrapped-linker-option${imageProcessing_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR imageProcessing_NUM_DUMMY_TARGETS "${imageProcessing_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::imageProcessing::wrapped-linker-option${imageProcessing_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND imageProcessing_LIBRARIES "${interface_target_name}")
